    ...
    <div className="app-container">
      ...
      <div className="max-w-6xl mx-auto px-4 py-16 space-y-24 relative z-10">
        ...
        {showPrompt && (
          <div className="mb-8">
            <div
              className="bg-gradient-to-r from-pink-400 via-purple-500 to-pink-400 text-white px-8 py-4 rounded-full cursor-pointer shadow-xl transition-all duration-300 hover:scale-105 animate-bounce mx-auto w-fit"
            ...
            >
              <span className="font-medium flex items-center gap-2">
                ...
                💕 Clique para adicionar música ao momento
                <svg className="w-5 h-5 animate-pulse" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z" />
                </svg>
              </span>
